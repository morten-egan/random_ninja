...
as
  ...
  */
  ...
  -- Chinese characters
  g_most_used_chinese_characters  varchar2(32000) := '一丁世丂七丌丘不且丙丑业並中丰㐄乃久乇乍丸丹主了予莫水氵木林束未東果本相桼朿朩枼手扌才品古各同吉台召咅啇員司單告句史可呂后合右善吳周呆心忄思必虫車石二亘井云于五亏亞亍白百竹厶去禸禺彡 足回囟囪因匹亼从俞僉介今令余倉來全彳行金女妻婁妾肉肖能肙朋有朝多夗舛堯垂坴堇壴声壽糸糹言䜌炎馬鳥岡昔早是旨星易昜旬曰曷曾會曲曹更阝耳玉目眉直网安它寅宗冥犬犮豸乙乚九乞也乡颉角羽矛魚色衣袁襄禾委夂夌复夆攴敝攸敖又及取叚隹雚刀刃刂分㓞前田由甲申电異男畐畺广庚庶厂貝責力加大天夭夬央奄夫夷夸矢酉酋頁巾市帝帛十千卅卒半午卑卓卉門亠文亡交享亶㐬京亢亥示礻祭寸專尃雨需欠次穴革斤尸尹工左巨巫皿監羊韺八共兼公具其典父米食弓弗殳子舟孛方毛歹死弋戈戔我戊或戉戠立匕北比見爪爭爰走牛豕骨勹勺勻包勿干儿兀光元兌兄先免几幺幾風飛彐彔鹿非鬼冂冉再冊冏用甫甬韋豆豈青音黑臼舁廾廿开缶艮皮辛辡辟至齒卜龍生高瓦舌止此正戶气虎耒小少尞尚尗而卩㔾卯卬里重甘己巳巴巽襾西辰玄瓜谷鼠齊支牙巛巠川巤黃斗臣爿片聿鬲氏民氐麻尢自面老凵出凶赤身鼻髟長釆采无疋毋每屮屰癶隶粦';
  ...
  -- Logistics globals
  g_shipping_bic_countries_implemented    varchar2(32000) := 'Algeria,Angola,Argentina,Australia,Austria,Azerbaijan,Bahamas,Bangladesh,Barbados,Belarus,Belgium,Belize,Bermuda,Brazil,Bulgaria,Cambodia,Cameroon,Canada,Cape Verde,Cayman Islands,Chile,China,Colombia,Congo,Costa Rica,Cote d''Ivoire,Croatia,Cuba,Cyprus,Czech Republic,Denmark,Djibouti,Dominican Republic,Egypt,Estonia,Ethiopia,Fiji,Finland,France,French Guiana,Georgia,Germany,Greece,Greenland,Guam,Hong Kong SAR China,Haiti,Hungary,Iceland,India,Indonesia,Iran,Ireland,Israel,Italy,Japan,Jordan,Kazakhstan,Kenya,South Korea,Kuwait,Latvia,Lebanon,Lithuania,Luxembourg,Malaysia,Maldives,Malta,Marshall Island,Mauritania,Mauritius,Mayotte,Mexico,Moldova,Monaco,Mongolia,Morocco,Mozambique,Nepal,Netherlands,Netherlands Antilles,New Caledonia,New Zealand,Norway,Oman,Pakistan,Panama,Papua New Guinea,Paraguay,Peru,Philippines,Poland,Porto Rico,Portugal,Qatar,Reunion,Romania,Russia,Saudi Arabia,Seychelles,Singapore,Slovakia,Slovenia,South Africa,Spain,Sri Lanka,Suriname,Sweden,Switzerland,Taiwan,Tanzania,Thailand,Togo,Trinidad and Tobago,Turkey,Turkmenistan,Ukraine,United Arab Emirates,United Kingdom,United States,Uruguay,Vanuatu,Venezuela,Vietnam,British Virgin Islands';

  -- Locale implmentation variables.
